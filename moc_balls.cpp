...
struct qt_meta_stringdata_BallView_t {
    QByteArrayData data[1];
    char stringdata[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BallView_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BallView_t qt_meta_stringdata_BallView = {
    {
...
const QMetaObject BallView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_BallView.data,
      qt_meta_data_BallView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BallView.stringdata))
